...
checkImage2: ^sdl.Surface
checkImage3: ^sdl.Surface
checkImage4: ^sdl.Surface
checkImage5: ^sdl.Surface
	...
	if clay.UI()(
	{
		...
		if clay.UI()(
		{
			...
			if clay.UI()(
			{
				...
				layout = {
					sizing = {clay.SizingPercent(0.35 + 0.3 * f32(lerpValue)), clay.SizingGrow()},
					childAlignment = {y = .Center},
					padding = clay.PaddingAll(16),
				},
				backgroundColor = ColorLerp(COLOR_RED, COLOR_ORANGE, f32(lerpValue)),
			},
			) {
				clay.Text(
					LOREM_IPSUM_TEXT,
			...
			if clay.UI()(
			{
				...
				backgroundColor = ColorLerp(COLOR_ORANGE, COLOR_RED, f32(lerpValue)),
			},
			) {
				clay.Text(
					LOREM_IPSUM_TEXT,
...
HighPerformancePageDesktop :: proc(lerpValue: f64) {
	if clay.UI()(
	{
...
HighPerformancePageMobile :: proc(lerpValue: f64) {
	if clay.UI()(
	{
...
RendererPage :: proc(titleTextConfig: clay.TextElementConfig, widthSizing: clay.SizingAxis) {
	...
	if clay.UI()(
	{
		...
		RendererButtonActive(0, "SDL3 Renderer")
	}
}
...
main :: proc() {
	...
	checkImage1 = image.Load("resources/check_1.png")
	checkImage2 = image.Load("resources/check_2.png")
	checkImage3 = image.Load("resources/check_3.png")
	checkImage4 = image.Load("resources/check_4.png")
	checkImage5 = image.Load("resources/check_5.png")
